...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-29 12:08`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/958a1241-48fa-432b-bdb3-b3d94fa075a9.git
$ cd 958a1241-48fa-432b-bdb3-b3d94fa075a9
```
